...
der die Zustände untersucht werden \cite{ai-modern-approach,
a-review-of-game-tree-pruning, an-analysis-of-alpha-beta-pruning}. Eine
ungünstige Zugreihenfolge kann dazu führen, dass Forward-Pruning-Verfahren auch
gute Züge verwerfen und damit die Genauigkeit der Suche beeinträchtigen. Beim
Alpha-Beta-Verfahren führt eine schlechte Zugordnung zwar nicht zu falschen
Ergebnissen, kann die Suche jedoch deutlich verlangsamen, da ungünstige Züge
früh untersucht werden können und dadurch weniger Möglichkeiten zum Abschneiden
entstehen.
...
Minimax-Algorithmus \cite{ai-modern-approach}.
...
$O(b^{m/2})$ \cite{ai-modern-approach}.
...
noch eine Reihe „offener“ Züge enthalten, wie Schläge oder Umwandlungen im
...
Abbildung~\ref{fig:chess-position-illustrating-horizon-effect}
\cite{ai-modern-approach}, würde den Zug \texttt{Bxb3} finden, der nach
Materialbewertung einen Bauern gewinnt. Aufgrund der begrenzten Tiefe erkennt
das Verfahren jedoch nicht, dass anschließend eine Figur verloren geht, wodurch
der anfängliche Materialvorteil wieder verloren ist.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{Abbildungen/chess-position-illustrating-horizon-effect.png}
    \caption{Schachstellung zur Veranschaulichung des Horizon-Effekts (Schwarz am Zug) \cite{ai-modern-approach}}
