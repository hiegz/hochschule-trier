...
\title{Titel Ihrer Abschluss- oder Seminararbeit}
\project{Bachelor-Thesis / Seminararbeit}
...
\supervisorFirst{Prof. Dr. Vorname Nachname}
...
\frontmatter
\input{Kapitel/Vorwort}                                % Vorwort (optional)
\input{Kapitel/Kurzfassung}    						% Kurzfassung/Abstract (nur bei Abschlussarbeiten)
...
\input{Kapitel/02_Konzeptionelle_Grundlagen.tex}
\input{Kapitel/03_Hauptteil.tex}
\input{Kapitel/04_Schlussbetrachtung.tex}
...
%------------------ Anhänge ----------------------------------------------------
\begin{appendix}
	\input{Anhang/Glossar.tex}						% Glossar (optional)
    \input{Anhang/01_Haeufige_Fehler.tex}
    \input{Anhang/02_Wissenschaftliche_Methode.tex}
\end{appendix}
\input{Kapitel/Eidesstaatliche_Erklaerung}                  % Eidesstaatliche Erklärung
