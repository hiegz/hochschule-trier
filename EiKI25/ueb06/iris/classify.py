...
# Wandele die Zeichenkette der species in Zahlen um (z.B. Iris-setosa -> 0, ....)
...
# Aufbau neuronales Netzes: Eingabeschicht mit 4 Features, verborgene Schichten mit 32 bzw. 64 Neuronen, Ausgabeschicht mit 3 Neuronen (da 3 Klassen) (Softmax (klassische Klassifikation)
